const slideInfo = [
  ...
  },
  {
    "id": "m1l1f02",
    "title": false,
    "narration": "<p>This lesson provides the fundamentals of the DOD personnel recovery system to guide DOD, interagency, coalition and contractor personnel who need to understand DOD personnel recovery.  After completing this lesson, you will be able to:</p><ul><li>Identify the US Government’s approach to Personnel Recovery<li>Identify the DOD Personnel Recovery system</ul>",
    "cuePoint": 0,
    "layout": 0,
    "optionalTxt": false,
    "audio": true,  
  ...
  },
  {
    "id": "m1l1f12",
    "title": "DOD PR System",
    "narration": "<p>The DOD PR System is comprised of four functions: preparation, planning, execution, and adaptation.</p><p>The PR system prepares three elements: commanders and staff, recovery forces, and isolated personnel by educating, training, and equipping them to plan and execute PR.</p><p>The functions are not discreet steps, but rather activities that continuously interact with one another, and adjust or adapt to maintain a relevant and effective system.</p>",
    "cuePoint": 0,
    "layout": 2,
    "optionalTxt": false,
    "audio": true,    
  ...
  },
  {
    ...
    "narration": "<p>The <b>recover</b> task involves the coordinated actions and efforts of commanders and staffs, recovery forces, and isolated personnel. The objective is to bring the isolated person under the physical custody of a friendly organization. The recover task begins when planning is initiated for recovering an isolated person and ends when the recovery element hands off the formerly isolated person to the reintegration team.</p><p>The PR mission execution decision is based on the PR command authorities established and based on a commander’s awareness of the situation and level of confidence in data collected.  Recovery forces can be launched and/or given an execute order at any time after a PR incident report is received.</p><p>A PR mission is closed when the recovered IP has been reintegrated or when the death of an IP is confirmed.</p>",
    "cuePoint": 0,
    "layout": 0,
    "optionalTxt": false,
    "audio": true,     
  ...
  },
  {
    "id": "m1l1f35",
    "title": false,
    "narration": "<p>Congratulations!<p>This concludes the DOD Personnel Recovery System lesson. You should now be able to:</p><ul><li>Identify the US Government’s approach to Personnel Recovery<li>Identify the DOD Personnel Recovery system</ul>",
    "cuePoint": 0,
    "layout": 0,
    "optionalTxt": false,
    "audio": true, 
